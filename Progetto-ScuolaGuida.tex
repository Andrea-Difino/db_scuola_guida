...
\section{Progettazione Logica}{
    ...
    \subsection{Analisi delle ridondanze}{
        ...
        \begin{itemize}
            ...
            \item \textbf{Operazione 2 (200 a settimana)} : Visualizza le recensioni attualmente presenti per Istruttori e Lezioni.
        \end{itemize}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|>{\centering\arraybackslash}p{2.6cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{3cm}|}
                ...
                \hline
                \rowcolor{white!40}
                Feedback & R & Recensione\\
                \hline
                \rowcolor{white!40}
                Recensione & E & Recensione\\
                \hline
            \end{tabular}
        \end{table}
