...
\section{Progettazione Concettuale}{
    ...
    \begin{enumerate}
        ...
        \item Il numero di partecipanti a una lezione teorica non può superare il numero di posti disponibili nell'aula assegnata:
        \[(l,a)\in Assegnazione \land l.NumeroPartecipanti > a.Posti \Rightarrow \text{Vincolo Violato}\]
...
\section{Progettazione Logica}{
    ...
    \subsection{Analisi delle ridondanze}{
        ...
        \begin{itemize}
            ...
            \item \textbf{Operazione 2 (200 a settimana)} : siano effettuate in media 200 letture a settimana del numero di partecipanti (Operazione 2).
        \end{itemize}
