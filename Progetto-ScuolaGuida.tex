...
\section{Progettazione Logica}{
    In questa sezione viene presentato lo schema logico relazionale derivato dal modello concettuale. Ciascuna entità concettuale è trasformata in una tabella, definendo attributi, chiavi primarie e chiavi esterne per rappresentare i legami. Gli attributi ridondanti verranno rimossi per migliorare l’efficienza di archiviazione e accesso. Le generalizzazioni concettuali sono risolte mediante l’introduzione di un attributo discriminante che distingue i tipi di istanza, con i campi specifici resi NULLABLE.
     \begin{table}[H]
        \centering
