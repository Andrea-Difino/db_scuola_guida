...
\section{Progettazione Logica}{
    ...
    \subsection{Scelta di identificatori primari}{
        ...
        \textbf{Pagamento.} \\ 
        Assumiamo che ogni Iscritto possa effetturare piu' di un pagamento in un giorno per cui, al fine di minimizzare le chiavi primarie ID abbiamo deciso di identificare 
        ogni pagamento mediante una chiave primaria composta dall'attributo \textit{Data} e dall'attributo \textit{Importo}.
    }
