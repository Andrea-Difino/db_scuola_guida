...
\section{Progettazione Concettuale}{
    ...
    \begin{enumerate}
        \item Un istruttore i non può tenere contemporaneamente più lezioni. Se un istruttore insegna due lezioni $l_1$ e $l_2$, allora le date devono differire:
        \vspace{-.1cm}
        \[(l_1,i)\in Insegnamento\land (l_2 ,i)\in Insegnamento\Rightarrow(l_1.Data\neq l_2.Data)\]
        \item Un iscritto s non può partecipare a due esami nello stesso momento. Un iscritto non può sostenere due esami $e_1$ ed $e_2$ nello stesso giorno:
        \vspace{-.1cm}
        ...
        \item Una recensione non può riferirsi contemporaneamente ad una lezione e ad un istruttore. 
...
\begin{figure}[h]        
    \includegraphics[width=.955\linewidth]{img/ER_ScuolaGuida.drawio.png}\centering
...
\section{Progettazione Logica}{
    ...
    L'attributo composto \textit{Città} viene reso una tabella a sè stante e suddiviso in tre attributi distinti: CAP, Provincia e Nome, per facilitare la gestione dei dati. \\
...
delle Query}{
    ...
    Il file \texttt{ScuolaGuida.sql} contiene il codice SQL necessario per la creazione e il popolamento delle tabelle del database. Questo file include inoltre una serie di query per l’estrazione dei dati e un indice creato specificamente per migliorare le prestazioni
    ...
    \subsection{Definizione delle query}{
        ...
        $$
            \includegraphics[width=.45\linewidth]{img/query1.png}
        $$

        Un estratto dell'output: 

        $$
            \includegraphics[width=.5\linewidth]{img/risultati1.png}
        $$
        ...
        $$
            \includegraphics[width=.7\linewidth]{img/query3.png}
        $$

        Un estratto dell'output: 

        $$
            \includegraphics[width=.8\linewidth]{img/risultati3.png}
        $$
        ...
        $$
            \includegraphics[width=.5\linewidth]{img/risultati4.png}
        $$
        ...
        $$
            \includegraphics[width=.65\linewidth]{img/risultati5.png}
        $$
    }
    ...
    \begin{enumerate}
        \item Condizione di Join tra le tabelle Veicolo, Lezione, Prenotazione e Iscritto, in particolare:
        \begin{itemize}
            \item v.Targa = l.VeicoloUsato
            \item l.Data = p.DataLezione
            \item l.ArgomentoLezione = p.ArgomentoLezione
    ...
    Per ottimizzare i punti precedenti, si propongono i seguenti indici:
        ...
        L'indice \textbf{idx\_prenotazione\_data\_argomento} su Prenotazione (DataLezione, ArgomentoLezione): ottimizza la join tra Prenotazione e Lezione tramite i campi DataLezione e ArgomentoLezione.
    }

    \section{Applicazione Software}{
        Il file \texttt{ScuolaGuidaQuery.c} contiene il codice C necessario per connettersi al database e 
        ...
        \begin{itemize}
            \item 1. \texttt{(Parametrica)} Numero di esami teorici sostenuti per ogni tipo di patente, media punti e promossi. 
            ...
            \item 4. \texttt{(Parametrica)} Elenco degli iscritti che hanno effettuato almeno un pagamento mostrando per ciascuno quanto hanno versato e la patente per cui stanno studiando.
            \item 5. \texttt{(Parametrica)} Calcolo della media di gradimento ricevuta da un istruttore e del numero di recensioni scritte da iscritti per ogni istruttore.
        \end{itemize}
