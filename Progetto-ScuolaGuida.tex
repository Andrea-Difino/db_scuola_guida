...
\section{Progettazione Logica}{
    ...
    \subsection{Analisi delle ridondanze}{
        ...
        Si stima che vengano inserite circa 60 recensioni nuove a settimana, mentre la lettura delle recensioni avviene in media 200 volte al giorno da parte del personale o dei sistemi di report.
        ...
        \[
            \text{Costo Totale} = 60 \times 3 \times 2 + 60 + 200 = \boxed{620}
        \]
        ...
        \begin{itemize}
            ...
            \item \textbf{Operazione 2}:  (con circa 3000/1000 = 3 recensioni per iscritto):
        ...
        Assumendo \textit{costo doppio per gli accessi in scrittura}, il costo totale è:
        \[
            \text{Costo Totale} = 60 \times 3 \times 2 + (200 \times 3) + (200 \times 2) = \boxed{1.360}
        \]

        L’analisi suggerisce quindi di tenere l’attributo ridondante, ottimizzando cos` ı il
        numero di accessi.
    }
}
